...
import com.khamdannahari.norrisjokes.BuildConfig
import com.khamdannahari.norrisjokes.application.repository.JokeRepository
import com.khamdannahari.norrisjokes.data.net.JokeApiService
import com.khamdannahari.norrisjokes.data.net.NetJokeRepository
...
class ApplicationModule(private val application: App) {
    ...
    @Provides fun provideJokeRepository(jokeApiService: JokeApiService): JokeRepository =
        NetJokeRepository(jokeApiService)
